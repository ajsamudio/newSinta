const products = {
    "moonlit-pearl": {
        ...
        "description": "Hand-selected freshwater pearls suspended on a delicate 14k gold-filled chain. Each pearl carries its own unique luster and shape, making every piece a one-of-a-kind treasure from the sea.",
    ...
    "siren-earrings": {
        "name": "Siren Drop Earrings",
        "price": "$45",
        "material": "Sterling Silver",
        "description": "Inspired by the foam of moonlit waves, these drop earrings feature shimmering silver droplets and sea-kissed textures.",
    ...
    "tide-bracelet": {
        "name": "Tide Flow Bracelet",
        "price": "$62",
        "material": "14K Gold Fill",
        "description": "A fluid, organic bracelet that mimics the gentle pull of the tide. Crafted for those who find peace by the shore.",
